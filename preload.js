...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onTranscriptionOpen: (callback) => ipcRenderer.on('transcription-open', () => callback()),
  onTranscriptionClose: (callback) => ipcRenderer.on('transcription-close', (event, code) => callback(code)),
  onTranscriptionMetadata: (callback) => ipcRenderer.on('transcription-metadata', (event, meta) => callback(meta)),
  onTranscriptionSilence: (callback) => ipcRenderer.on('transcription-silence', () => callback()),
